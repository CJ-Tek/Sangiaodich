...
export default async function SaleBookingsPage({
  ...
  const t = await getTranslations('sale.bookings');
  ...
  > = {
    ALL: { emptyTitle: t('emptyAllTitle'), emptyDescription: t('emptyAllDesc') },
    PENDING: {
      emptyTitle: t('emptyPendingTitle'),
      emptyDescription: t('emptyPendingDesc'),
    },
    AWAITING_OWNER: {
      emptyTitle: t('emptyAwaitingTitle'),
      emptyDescription: t('emptyAwaitingDesc'),
    },
    CONFIRMED: {
      emptyTitle: t('emptyConfirmedTitle'),
      emptyDescription: t('emptyConfirmedDesc'),
    },
    CHECKED_IN: {
      emptyTitle: t('emptyCheckedInTitle'),
      emptyDescription: t('emptyCheckedInDesc'),
    },
    CHECKED_OUT: {
      emptyTitle: t('emptyCheckedOutTitle'),
      emptyDescription: t('emptyCheckedOutDesc'),
    },
    CANCELLED: {
      emptyTitle: t('emptyCancelledTitle'),
      emptyDescription: t('emptyCancelledDesc'),
    },
  };

  const empty = emptyMeta[filter];
  const emptyDescription =
    simple && filter === 'PENDING'
      ? t('emptyPendingDescSimple')
  ...
  return (
    <>
      <PageHeader
        title={t('title')}
        description={simple ? t('descSimple') : t('descExpert')}
      />
      <Stack gap="md" mb="lg">
